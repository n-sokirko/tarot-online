...
const labels = {
  ru: {
    ...
    payRequired:
      'Нужна Premium-подписка или кредиты, чтобы продолжить.',
    pricing: 'Открыть тарифы',
    footnote:
      'Интерпретация сгенерирована AI. Это не предсказание — это зеркало.',
...
export default function InterpretationPanel({ readingId, locale, initial }: InterpretationPanelProps) {
  ...
  // ── Input form: question textarea + submit button ─────────────
  return (
      ...
      <AnimatePresence mode="wait">
        {loading ? (
          ...
          >
            ...
            {/* Show the question user typed while loading */}
            {question && (
              <p
