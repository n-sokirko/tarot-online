...
const COPY = {
  ...
  de: {
    ...
    subtitle: 'Tarot Online lebt dank dir. Schenke ein paar Sterne ⭐',
    custom: 'Eigener Betrag',
    custom_placeholder: 'Wie viele Sterne?',
    donate: 'Schenken',
    donating: 'Zahlung wird geöffnet…',
    thanks: '✨ Danke für deine Unterstützung! Dein Geschenk wärmt das Projekt.',
    cancelled: 'Zahlung abgebrochen.',
    error: 'Zahlung konnte nicht geöffnet werden. Versuche es erneut.',
    login_needed: 'Melde dich an, um das Projekt zu unterstützen.',
    close: 'Schließen',
    stars: 'Sterne',
  },
  fr: {
    title: 'Soutenir le projet',
    subtitle: 'Tarot Online vit grâce à toi. Offre quelques étoiles ⭐',
    custom: 'Montant libre',
    custom_placeholder: 'Combien d’étoiles ?',
    donate: 'Offrir',
    donating: 'Ouverture du paiement…',
    thanks: '✨ Merci pour ton soutien ! Ton don réchauffe le projet.',
    cancelled: 'Paiement annulé.',
    error: 'Impossible d’ouvrir le paiement. Réessaie.',
    login_needed: 'Connecte-toi pour soutenir le projet.',
    close: 'Fermer',
    stars: 'étoiles',
  },
  es: {
    title: 'Apoyar el proyecto',
    subtitle: 'Tarot Online vive gracias a ti. Regala unas estrellas ⭐',
    custom: 'Cantidad libre',
    custom_placeholder: '¿Cuántas estrellas?',
    donate: 'Regalar',
    donating: 'Abriendo el pago…',
    thanks: '✨ ¡Gracias por tu apoyo! Tu regalo abriga el proyecto.',
    cancelled: 'Pago cancelado.',
    error: 'No se pudo abrir el pago. Inténtalo de nuevo.',
    login_needed: 'Inicia sesión para apoyar el proyecto.',
    close: 'Cerrar',
    stars: 'estrellas',
  },
  pt: {
    title: 'Apoiar o projeto',
    subtitle: 'Tarot Online vive graças a ti. Oferece algumas estrelas ⭐',
    custom: 'Valor livre',
    custom_placeholder: 'Quantas estrelas?',
    donate: 'Oferecer',
    donating: 'A abrir o pagamento…',
    thanks: '✨ Obrigado pelo teu apoio! O teu presente aquece o projeto.',
    cancelled: 'Pagamento cancelado.',
    error: 'Não foi possível abrir o pagamento. Tenta novamente.',
    login_needed: 'Inicia sessão para apoiar o projeto.',
    close: 'Fechar',
    stars: 'estrelas',
  },
  uk: {
    title: 'Підтримати проєкт',
    subtitle: 'Tarot Online живе завдяки вам. Подаруй трохи зірок ⭐',
    custom: 'Своя сума',
    custom_placeholder: 'Скільки зірок?',
    donate: 'Подарувати',
    donating: 'Відкриваю оплату…',
    thanks: '✨ Дякуємо за підтримку! Твій дар зігріває проєкт.',
    cancelled: 'Оплату скасовано.',
    error: 'Не вдалося відкрити оплату. Спробуй ще раз.',
    login_needed: 'Увійди, щоб підтримати проєкт.',
    close: 'Закрити',
    stars: 'зірок',
  },
} as const;
