...
const STRINGS = {
  ...
  de: {
    title: 'Tageskarte',
    subtitle: 'Eine Karte für heute — eine Botschaft, die deine Aufmerksamkeit verdient',
    reveal: 'Karte aufdecken',
    revealing: 'Wird enthüllt...',
    todayLabel: 'Heute',
    reversedNote: 'Umgekehrte Position',
    upright: 'Aufrechte Bedeutung',
  ...
  fr: {
    title: 'Carte du jour',
    subtitle: 'Une carte pour aujourd’hui — un message qui mérite ton attention',
    reveal: 'Révéler la carte',
    revealing: 'Révélation...',
    todayLabel: 'Aujourd’hui',
    reversedNote: 'Position inversée',
    upright: 'Signification à l’endroit',
    reversed: 'Signification inversée',
    keywords: 'Thèmes clés',
    reflection: 'Réflexion',
    error: 'Une erreur est survenue. Réessaie.',
  },
  es: {
    title: 'Carta del día',
    subtitle: 'Una carta para hoy — un mensaje que merece tu atención',
    reveal: 'Revelar la carta',
    revealing: 'Revelando...',
    todayLabel: 'Hoy',
    reversedNote: 'Posición invertida',
    upright: 'Significado al derecho',
    reversed: 'Significado invertido',
    keywords: 'Temas clave',
    reflection: 'Reflexión',
    error: 'Algo salió mal. Inténtalo de nuevo.',
  },
  pt: {
    title: 'Carta do dia',
    subtitle: 'Uma carta para hoje — uma mensagem que merece a tua atenção',
    reveal: 'Revelar a carta',
    revealing: 'A revelar...',
    todayLabel: 'Hoje',
    reversedNote: 'Posição invertida',
    upright: 'Significado normal',
    reversed: 'Significado invertido',
    keywords: 'Temas-chave',
    reflection: 'Reflexão',
    error: 'Algo correu mal. Tenta novamente.',
  },
  uk: {
    title: 'Карта дня',
    subtitle: 'Одна карта на сьогодні — послання, на яке варто звернути увагу',
    reveal: 'Відкрити карту',
    revealing: 'Розкривається...',
    todayLabel: 'Сьогодні',
    reversedNote: 'Перевернуте положення',
    upright: 'Пряме значення',
    reversed: 'Перевернуте значення',
