...
const COPY = {
  ...
  de: {
    title: 'Runen werfen',
    subtitle: 'Älteres Futhark. 24 Zeichen, jedes ein Wort älter als jede Sprache.',
    question_placeholder: 'Was möchtest du die Runen fragen? (optional)',
    layouts: {
      single: { title: 'Eine Rune', desc: 'Ein Zeichen für den Tag' },
      three: { title: 'Drei Runen', desc: 'Was ist · Was nötig ist · Wohin schauen' },
      five: { title: 'Fünf-Runen-Kreuz', desc: 'Tiefe Legung' },
    },
    cast: 'Werfen',
    casting: 'Runen werden gezogen...',
    free: 'Kostenlos',
    premium: 'Premium',
  },
  fr: {
    title: 'Tirer les runes',
    subtitle: 'Futhark ancien. 24 signes, chacun un mot plus ancien que toute langue.',
    question_placeholder: 'Que veux-tu demander aux runes ? (facultatif)',
    layouts: {
      single: { title: 'Une rune', desc: 'Un signe pour la journée' },
      three: { title: 'Trois runes', desc: 'Ce qui est · Ce qu’il faut · Où regarder' },
      five: { title: 'Croix de cinq runes', desc: 'Tirage profond' },
    },
    cast: 'Tirer',
    casting: 'On tire les runes...',
    free: 'Gratuit',
    premium: 'Premium',
  },
  es: {
    title: 'Lanzar las runas',
    subtitle: 'Futhark antiguo. 24 signos, cada uno una palabra más vieja que cualquier idioma.',
    question_placeholder: '¿Qué quieres preguntar a las runas? (opcional)',
    layouts: {
      single: { title: 'Una runa', desc: 'Un signo para el día' },
      three: { title: 'Tres runas', desc: 'Qué hay · Qué hace falta · Dónde mirar' },
      five: { title: 'Cruz de cinco runas', desc: 'Tirada profunda' },
    },
    cast: 'Lanzar',
    casting: 'Sacando las runas...',
    free: 'Gratis',
    premium: 'Premium',
  },
  pt: {
    title: 'Lançar as runas',
    subtitle: 'Futhark antigo. 24 sinais, cada um uma palavra mais antiga que qualquer língua.',
    question_placeholder: 'O que queres perguntar às runas? (opcional)',
    layouts: {
      single: { title: 'Uma runa', desc: 'Um sinal para o dia' },
      three: { title: 'Três runas', desc: 'O que é · O que é preciso · Onde olhar' },
      five: { title: 'Cruz de cinco runas', desc: 'Tiragem profunda' },
    },
    cast: 'Lançar',
    casting: 'A tirar as runas...',
    free: 'Grátis',
    premium: 'Premium',
  },
  uk: {
    title: 'Кидок рун',
    subtitle: 'Старший Футарк. 24 знаки, кожен — слово, давніше за будь-яку мову.',
    question_placeholder: 'Що хочеш запитати в рун? (можна лишити порожнім)',
    layouts: {
      single: { title: 'Одна руна', desc: 'Знак на день' },
      three: { title: 'Три руни', desc: 'Що є · Що потрібно · Куди дивитися' },
      five: { title: 'П’ятірний хрест', desc: 'Глибокий розбір' },
    },
    cast: 'Кинути',
    casting: 'Дістаємо руни...',
    free: 'Безкоштовно',
    premium: 'Premium',
  },
} as const;
