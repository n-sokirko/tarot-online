...
export default function LoginPage() {
  ...
  }, [email, password, router, t, refetch]);
      ...
      >
        ...
        <form onSubmit={(e) => void handleSubmit(e)} className="flex flex-col gap-4">
          <input
            ...
            placeholder={t('email')}
            required
            className="w-full px-4 py-3 rounded-xl font-sans text-sm bg-transparent outline-none"
            style={{
        ...
        <p className="text-xs text-center" style={{ color: 'rgba(242,237,228,0.4)' }}>
          <Link href="/register" style={{ color: 'rgba(224,178,108,0.6)' }}>
            {t('register_link')}
          </Link>
        </p>
      </motion.div>
