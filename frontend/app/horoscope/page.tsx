...
const STRINGS = {
  ...
  de: {
    title: 'Horoskop',
    heading: 'Horoskop für heute',
    subtitle: 'Wähle dein Sternzeichen und sieh, was dieser Tag atmet',
    pick: 'Zeichen wählen',
    back: '← Alle Zeichen',
    overall: 'Ton des Tages',
    love: 'Liebe',
    career: 'Arbeit & Geld',
    wellbeing: 'Wohlbefinden',
    mood: 'Stimmung des Tages',
    lucky_number: 'Zahl des Tages',
    lucky_color: 'Farbe des Tages',
    energy: 'Energie',
    deep: 'Ausführliches KI-Horoskop',
    interpreting: 'Die Sterne ordnen sich...',
    deep_cta: 'Kostet 1 Guthaben. Guthaben mit Sternen ⭐ kaufen oder mit Premium erhalten.',
    login_cta: 'Zum Freischalten anmelden',
    error: 'Etwas ist schiefgelaufen. Bitte versuche es erneut.',
  },
  fr: {
    title: 'Horoscope',
    heading: 'Horoscope du jour',
    subtitle: 'Choisis ton signe du zodiaque et découvre ce que respire ce jour',
    pick: 'Choisir un signe',
    back: '← Tous les signes',
    overall: 'Ton du jour',
    love: 'Amour',
    career: 'Travail & argent',
    wellbeing: 'Bien-être',
    mood: 'Humeur du jour',
    lucky_number: 'Nombre du jour',
    lucky_color: 'Couleur du jour',
    energy: 'Énergie',
    deep: 'Horoscope IA détaillé',
    interpreting: 'Les étoiles s’alignent...',
    deep_cta: 'Coûte 1 crédit. Achète des crédits avec des étoiles ⭐ ou obtiens-les avec Premium.',
    login_cta: 'Connecte-toi pour débloquer',
    error: 'Une erreur est survenue. Réessaie.',
  },
  es: {
    title: 'Horóscopo',
    heading: 'Horóscopo de hoy',
    subtitle: 'Elige tu signo del zodiaco y descubre qué respira este día',
    pick: 'Elige un signo',
    back: '← Todos los signos',
    overall: 'Tono del día',
    love: 'Amor',
    career: 'Trabajo y dinero',
    wellbeing: 'Bienestar',
    mood: 'Ánimo del día',
    lucky_number: 'Número del día',
    lucky_color: 'Color del día',
    energy: 'Energía',
    deep: 'Horóscopo IA detallado',
    interpreting: 'Las estrellas se alinean...',
    deep_cta: 'Cuesta 1 crédito. Compra créditos con estrellas ⭐ u obtenlos con Premium.',
    login_cta: 'Inicia sesión para desbloquear',
    error: 'Algo salió mal. Inténtalo de nuevo.',
  },
  pt: {
    title: 'Horóscopo',
    heading: 'Horóscopo de hoje',
    subtitle: 'Escolhe o teu signo do zodíaco e vê o que este dia respira',
    pick: 'Escolhe um signo',
    back: '← Todos os signos',
    overall: 'Tom do dia',
    love: 'Amor',
    career: 'Trabalho e dinheiro',
    wellbeing: 'Bem-estar',
    mood: 'Humor do dia',
    lucky_number: 'Número do dia',
    lucky_color: 'Cor do dia',
    energy: 'Energia',
    deep: 'Horóscopo IA detalhado',
    interpreting: 'As estrelas alinham-se...',
    deep_cta: 'Custa 1 crédito. Compra créditos com estrelas ⭐ ou obtém-nos com Premium.',
    login_cta: 'Inicia sessão para desbloquear',
    error: 'Algo correu mal. Tenta novamente.',
  },
  uk: {
    title: 'Гороскоп',
    heading: 'Гороскоп на сьогодні',
    subtitle: 'Обери свій знак зодіаку й дізнайся, чим дихає цей день',
    pick: 'Обери знак',
    back: '← Усі знаки',
    overall: 'Тон дня',
    love: 'Кохання',
    career: 'Справи та фінанси',
    wellbeing: 'Самопочуття',
    mood: 'Настрій дня',
    lucky_number: 'Число дня',
    lucky_color: 'Колір дня',
    energy: 'Енергія',
    deep: 'Детальний AI-гороскоп',
    interpreting: 'Зорі складаються...',
    deep_cta: 'Коштує 1 кредит. Кредити можна купити зірками ⭐ або отримати з Premium.',
    login_cta: 'Увійти, щоб відкрити',
